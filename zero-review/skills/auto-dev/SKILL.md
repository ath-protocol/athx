...
| [ath-protocol-verify](phases/ath-protocol-verify.md) | Verify ATH Protocol v0.1 compliance — attestation, PKCE, scope intersection, token security (optional, protocol work only) |
...
| ath-protocol-verify phase | error-handling, information-hiding (provider token isolation) |
...
| `contracts/ath-protocol.md` | When task involves ATH protocol endpoints, types, or flows |
| `phases/ath-protocol-verify.md` | After implementation, when task touches ATH protocol logic |
