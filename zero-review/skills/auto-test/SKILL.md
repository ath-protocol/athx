...
| ATH protocol flow testing | **Stable** | Any | Multi-step HTTP: discovery → register → authorize → token → proxy/api → revoke |
...
| `personas/ath-protocol.md` | When testing ATH protocol endpoints or trust handshake flows |
| `contracts/artifact.md` | For input format reference |
| `contracts/issue.md` | For output format reference |
| `contracts/ath-protocol.md` | When testing ATH protocol compliance — endpoints, error codes, flow |
